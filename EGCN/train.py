...
from data_processing.data_utils import ABSADatesetReader
from models.ascnn import ascnn
from models.lstm import lstm
from models.egcn import egcn


from depend_graph import process
...
if __name__ =='__main__':
    ...
    parser.add_argument('--model_name', default='egcn', type=str)
    ...
    model_dataset = {
        'twitter':'./datasets/acl-14-short-data/',
        'rest14': './datasets/semeval14/restaurant',
        'lap14': './datasets/semeval14/laptop',
        'rest15': './datasets/semeval15/restaurant',
        'rest16': './datasets/semeval16/restaurant'
    }
    ...
    input_colses = {
        ...
        # 'egcn': ['text_indices', 'aspect_indices', 'left_indices', 'dependency_graph'],
        'egcn': ['text_indices', 'aspect_indices', 'left_indices', 'dependency_tree'],
    ...
    opt.model_dataset = model_dataset[opt.dataset]
    ...
    # print(opt.model_dataset)
    # if opt.model_dataset == './datasets/acl-14-short-data/':
    #     filename1 = opt.model_dataset+'train.raw'
    #     filename2 = opt.model_dataset+'test.raw'
    # else:
    #     filename1 = opt.model_dataset+'_train.raw'
    #     filename2 = opt.model_dataset+'_test.raw'
    ...
    # # Print model's state_dict
    # for param_tensor in opt.model_class.state_dict():
    #     print(param_tensor, "\t", opt.model_class.state_dict()[param_tensor].size())
    # print("optimizer's state_dict:")
    # # Print optimizer's state_dict
    # for var_name in opt.optimizer.state_dict():
    #     print(var_name, "\t", opt.optimizer.state_dict()[var_name])
